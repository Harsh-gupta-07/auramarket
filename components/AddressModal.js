export default function AddressModal({ draft, onChange, onClose, onSubmit }) {
    return (
      <div className="fixed inset-0 z-50 bg-black/70">
        <div className="flex h-full w-full flex-col bg-white">
          ...
          <form onSubmit={onSubmit} className="flex-1 flex flex-col">
            ...
            <div className="border-t border-gray-100 px-6 py-4 flex flex-wrap gap-3 bg-white">
              <button type="submit" className="btn btn-neutral rounded-full px-6">
                Save address
              </button>
              <button
                type="button"
